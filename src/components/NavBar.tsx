...
const NavBar = () => (
  <motion.nav
    ...
    className="fixed top-0 left-0 right-0 z-30 px-6 md:px-8 py-4 flex items-center justify-between bg-background/80 backdrop-blur-xl border-b border-primary/10"
  >
